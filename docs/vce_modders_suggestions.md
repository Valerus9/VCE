...
Some issues are solved by Victoria Community's Engine already, some aren't, feel free to add your bitter experiences below for consideration post-1.0:
...
- Undocumented (VicCEngine lists all of them by the way) and inconsistent modifiers (some that can only be used on technologies and inventions)
...
# Victoria Community's Engine Community modding Suggestions
